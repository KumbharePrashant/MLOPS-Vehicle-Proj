...
from src.constants import DATABASE_NAME, MONGODB_USER, MONGODB_PASSWORD #,MONGODB_URL_KEY
    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        try:
            ...
            if MongoDBClient.client is None:
                ...
                encoded_password = quote_plus(mongo_db_password)
                mongo_db_url = f"mongodb+srv://{mongo_db_username}:{encoded_password}@vehproj.kcinnlp.mongodb.net/?retryWrites=true&w=majority&appName=VehProj"  # Retrieve MongoDB URL from environment variables
